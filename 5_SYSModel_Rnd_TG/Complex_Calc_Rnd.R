...
Complex_Calc_Rnd<-function(Complex,RNA_GI,Hyper_GI){
        ...
        switch(TG_Ele_Indx3, 
               "1"={
                 if (!is.null(TGs_GI3[[TG_Ele_Indx3]])){
                   ...
                   Result[[Res_IDX]]<<-Normal_Ele_Rnd(TGs3,RNA_GI,GI3,Hyper_GI)
                   Res_IDX<<-Res_IDX+1
                 }
               },
                 ...
                 if (!is.null(TGs_GI3[[TG_Ele_Indx3]])){
                   ...
                   if(length(Seen_Complex)){
                     ...
                     if (length(Complex_Eles3)){
                       ...
                       Complex_Calc_Rnd(TGs_GI3[[TG_Ele_Indx3]],RNA_GI,Hyper_GI)
                     }
                   }else{
                     Flag_Complex_Seen<<-c(Flag_Complex_Seen,Complex_Eles3)
                     source("Complex_Calc_Rnd.R")
