...
Analysis_Impact_RelTG<-function(){
  ...
  Raw_Mut_File <-paste0("../Data/MutRt_Raw_",CANCER_TYPE,".txt")
  ...
  filename_Res=paste0("Res_NonSyn_Wild_Impacts_",CANCER_TYPE,".txt")
  ...
  Summary_Name=paste0("Res_NonSyn_Wild_Summry_GI_",CANCER_TYPE,".txt")
  ...
  Filt_Sum_Name=paste0("Res_NonSyn_Wild_Summry_GI_Filtered_RelTG.txt")
  ...
  filename_Res=paste0("Res_NonSyn_Wild_Impacts_Filtered_RelTG_",CANCER_TYPE,".txt")
  write.table(Result,file=filename_Res,append=FALSE,sep = "\t",row.names = FALSE,col.names = TRUE)
  ...
  filename_Imp=paste0("Res_NonSyn_Wild_Summary_Impacts_",CANCER_TYPE,".txt")
  ...
  Filt_Sum_Name=paste0("Res_NonSyn_Wild_Summry_GI_Filtered_RelTG_NewFilter.txt")
  ...
  filename_Res=paste0("Res_NonSyn_Wild_Impacts_Filtered_RelTG_NewFilter_",CANCER_TYPE,".txt")
  ...
  filename_Imp=paste0("Res_NonSyn_Wild_Summary_Impacts_NewFilter_",CANCER_TYPE,".txt")
  write.table(Impcts,file=filename_Imp,append=FALSE,sep = "\t",row.names = FALSE,col.names = TRUE)
}