...
Mutation_Labels_Clean_Wildtype<-function (GI,Hyper_GI,TG_Par_Info,TG,SamplesAll){
  if(is.na(Hyper_GI)){
  ...
  NonSynonumous_Labels=c("Missense_Mutation","Frame_Shift_Del","Nonsense_Mutation","In_Frame_Del","Splice_Site","Frame_Shift_Ins","Translation_Start_Site","Nonstop_Mutation")
